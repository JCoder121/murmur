...
# "Chirp Dev" is a self-signed cert in the login keychain; a stable identity
...
SIGN_ID = $(shell security find-identity -v -p codesigning 2>/dev/null | grep -q "Chirp Dev" && echo "Chirp Dev" || echo "-")
